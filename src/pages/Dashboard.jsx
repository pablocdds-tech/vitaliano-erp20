    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <div className="p-3 sm:p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
            ...
            <p className={`text-lg sm:text-xl font-bold ${totalBancos < 0 ? 'text-red-600' : 'text-blue-600'}`}>{formatMoney(totalBancos)}</p>
          ...
          <div className="p-3 sm:p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
            ...
            <p className={`text-lg sm:text-xl font-bold ${totalCofres < 0 ? 'text-red-600' : 'text-amber-600'}`}>{formatMoney(totalCofres)}</p>
            <p className="text-xs text-slate-400 mt-1">{cofres.length} cofre(s)</p>
          </div>
          <div className="p-3 sm:p-4 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200">
            ...
            <p className="text-lg sm:text-xl font-bold text-emerald-600">{formatMoney(receberProx7)}</p>
          </div>
          <div className="p-3 sm:p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200">
            ...
            <p className="text-lg sm:text-xl font-bold text-red-600">{formatMoney(pagarProx7)}</p>
          </div>
        </div>
